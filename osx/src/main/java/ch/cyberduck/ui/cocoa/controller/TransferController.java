...
public final class TransferController extends WindowController implements TransferListener, NSToolbar.Delegate, NSMenu.Validation {
    ...
    public void start(final Transfer transfer, final TransferOptions options, final TransferCallback callback) {
        ...
        final TransferBackgroundAction action = new TransferCollectionBackgroundAction(this,
            null == source ? SessionPool.DISCONNECTED : SessionPoolFactory.create(this, source, cache, progress),
            null == destination ? SessionPool.DISCONNECTED : SessionPoolFactory.create(this, destination, cache, progress),
